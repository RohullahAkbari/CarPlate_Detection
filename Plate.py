...
images_n_vids_path = "./dataset/test"
image_path = os.path.join(images_n_vids_path, "./images/259_png.rf.55dee8ac4e25cdd637c41af59b7e00c4.jpg")
video_path = os.path.join(images_n_vids_path, "./persons_walking.avi")

device = torch.device('cpu')

savepath = "../plateDetection2"
...
def get_plates_from_video(source):
    ...
    os.system(f'del -rf {temp} ffmpeg2pass-0.log ffmpeg2pass-0.log.mbtree')
